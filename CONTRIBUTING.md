...
We welcome all contributions to Test Project with PyPI and ReadTheDocs!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/lilyminium/test_mda_pip_rtd/issues)
...
The second two options both involve making a [pull request](https://github.com/lilyminium/test_mda_pip_rtd/pulls) .
