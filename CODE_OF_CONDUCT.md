...
The Test Project with PyPI and ReadTheDocs *Code of Conduct* sets the rules for the behavior of
every member in the Test Project with PyPI and ReadTheDocs community so that everyone can
...
Test Project with PyPI and ReadTheDocs is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make Test Project with PyPI and ReadTheDocs a welcoming and productive community.
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and Test Project with PyPI and ReadTheDocs is no exception. It is important
   that we resolve disagreements and differing views constructively. Remember
   that we’re different. The strength of Test Project with PyPI and ReadTheDocs comes from its varied community
...
reported by contacting the project team at 'cookiemonster@trash.can'. The project team will
...
modified by Test Project with PyPI and ReadTheDocs.
